...
The Project Gutenberg integration is descriptor-driven: current firmware can read its `src/opds.json` provider and show
Project Gutenberg in the OPDS browser after the package is installed.
